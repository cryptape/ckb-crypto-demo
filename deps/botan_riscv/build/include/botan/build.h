...
* 'configure.py --cpu=riscv64 --without-os-feature=threads,thread_local,posix1,filesystem,getauxval --ar-command=/riscv/bin/riscv64-unknown-elf-gcc-ar --cc-bin=/riscv/bin/riscv64-unknown-elf-g++ --minimized-build --disable-shared-library --link-method=copy --enable-modules=sm2,sm3,ecdsa'
*
* Target
*  - Compiler: /riscv/bin/riscv64-unknown-elf-g++ -fstack-protector -pthread -std=c++11 -D_REENTRANT -O3
*  - Arch: riscv64
*  - OS: linux
*/
...
#define BOTAN_VERSION_VC_REVISION "git:538f1614cf4712c6267dadee02d7ebf20fd816f5"
...
#define BOTAN_TARGET_ARCH_IS_RISCV64
#define BOTAN_TARGET_CPU_IS_LITTLE_ENDIAN
#define BOTAN_TARGET_CPU_IS_RISCV_FAMILY
